  ...
  render() {
    return this.props.show ?
      <div className="filter">
        <button className="filter-chip" type="button" onClick={() => this.props.onFilterChange('pug')}>
          {this.props.active === 'pug' ? <img alt="Active Pug Checkmark" src={check}/> : null}
          <span>Pugs</span>
        </button>
        <button className="filter-chip" type="button" onClick={() => this.props.onFilterChange('puggle')}>
